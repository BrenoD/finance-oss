    ...
    <div style={{
      ...
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        html,body,#root{margin:0;padding:0;background:#070707;width:100%;height:100%}
      ...
      {/* scanline */}
      <div style={{
        position: "fixed", left: 0, right: 0, height: 3, zIndex: 0, pointerEvents: "none",
        ...
        <div style={{
          ...
          {!DB_READY ? (
            ...
            <>
              ...
              {err && (
                <div style={{
                  marginTop: "0.75rem", color: "#FF4757", fontSize: "0.75rem",
                  letterSpacing: "0.06em", textAlign: "center"
                }}>{err}</div>
              )}

              <div style={{
                marginTop: "1.25rem", color: "rgba(255,255,255,0.15)",
...
function InviteModal({ onClose, couple }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        background: "#090909", border: "1px solid rgba(255,255,255,0.09)", borderRadius: "16px",
        ...
        {hasPartner ? (
          ...
          <>
            ...
            <div style={{ display: "flex", gap: "0.45rem", marginBottom: "1rem" }}>
              <div style={{
                flex: 1, background: "#111", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "8px",
              ...
              <button onClick={copy} style={{
                padding: "0.7rem 1rem", background: copied ? "#2ED573" : "#FF69B4",
            ...
            <div style={{
              background: "rgba(255,105,180,0.05)", border: "1px solid rgba(255,105,180,0.12)",
...
function TogetherTab({ couple, user }) {
  ...
  return (
    <div style={{ animation: "fadeUp .32s ease both" }}>
      <div style={{
        display: "flex", alignItems: "center", justifyContent: "center", gap: "1rem", marginBottom: "1.25rem",
          ...
          {feed.map((item, i) => {
            ...
            return (
              <div key={item.id} style={{
                background: "#0c0c0c", border: "1px solid rgba(255,255,255,0.055)", borderRadius: "11px",
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", marginBottom: "1.5rem" }}>
          <div style={{
            width: 36, height: 36, borderRadius: "9px", background: "rgba(232,255,71,0.1)",
        ...
        {[
          ...
          <div key={step.n} style={{ display: "flex", gap: "0.875rem", marginBottom: "1.1rem" }}>
            <div style={{
              width: 28, height: 28, borderRadius: "50%", background: "rgba(232,255,71,0.1)",
        ...
        <div style={{
          background: "#060606", border: "1px solid rgba(255,255,255,0.08)",
  ...
  useEffect(() => {
    fetch("https://api.anthropic.com/v1/messages", {
      ...
      body: JSON.stringify({
        ...
        messages: [{
          role: "user", content: `Personal finance consultant. Reply in English, be direct.
...
1) Spending % breakdown 2) What to cut 3) Savings plan 4) 3/6/12 month projection 5) 3 tips. Emojis, real numbers. Max 300 words.`}]
  ...
  return (
    <div style={{
      ...
      <div style={{
        background: "#090909", border: "1px solid rgba(232,255,71,0.2)", borderRadius: "16px",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.875rem", marginBottom: "1.5rem" }}>
          <div style={{
            width: 38, height: 38, borderRadius: "9px", background: "rgba(232,255,71,0.08)",
            border: "1px solid rgba(232,255,71,0.2)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18
          }}>🤖</div>
          <div>
        ...
        {loading ? (<div style={{ textAlign: "center", padding: "3rem 0" }}>
          <div style={{
            width: 40, height: 40, border: "2px solid rgba(232,255,71,0.1)", borderTop: "2px solid #E8FF47",
  ...
  return (
    <div style={{ animation: "fadeUp .32s ease both" }}>
      ...
      <div style={{
        ...
        <div style={{
          padding: "0.7rem 1rem", borderBottom: "1px solid rgba(255,255,255,0.04)",
      ...
      {loadingW ? (
        <div style={{ textAlign: "center", padding: "2rem 0" }}>
          <div style={{
            width: 28, height: 28, border: "2px solid rgba(232,255,71,0.1)", borderTop: "2px solid #E8FF47",
        ...
        <div style={{ display: "grid", gap: "0.4rem" }}>
          {entries.length === 0 ? (
            <div style={{
              textAlign: "center", padding: "2rem 0", color: "rgba(255,255,255,0.1)",
              fontSize: "0.68rem", letterSpacing: "0.15em"
            }}>NO ENTRIES THIS WEEK</div>
          ) : entries.map((e, i) => (
            <div key={e.id} style={{
              background: "#0c0c0c", border: "1px solid rgba(255,255,255,0.055)",
      ...
      {(entries.length > 0 || subs.length > 0) && (
        <div style={{
          ...
          <span style={{
            ...
            color: weekBalance >= 0 ? "#E8FF47" : "#FF4757"
          }}>{fmt(weekTotal)}</span>
        </div>
      )}
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.1rem" }}>
              ...
              <button onClick={() => { setShowAddEntry(false); setEntryPayDate(null); }} style={{
                background: "none", border: "none",
                color: "rgba(255,255,255,0.28)", cursor: "pointer", fontSize: 17, padding: 0
              }}>×</button>
            </div>
            ...
            <div style={{ display: "flex", gap: "0.45rem" }}>
              <button onClick={() => { setShowAddEntry(false); setEntryPayDate(null); }} style={{
                ...
                borderRadius: "8px", color: "rgba(255,255,255,0.35)", cursor: "pointer", fontSize: "0.72rem", letterSpacing: "0.1em"
              }}>CANCEL</button>
              <button onClick={addEntry} disabled={saving} style={{
                flex: 1, padding: "0.65rem", background: "#FF4757",
...
function FinanceApp({ user, onSignOut }) {
  ...
  const addSub = async () => {
    ...
    try {
      const payload = {
        title: newSub.title, amount: parseFloat(newSub.amount),
  ...
  return (
    <div style={{
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 840, margin: "0 auto", padding: "1.25rem 1rem 6rem" }}>
        ...
        {loading && (
          <div style={{ textAlign: "center", padding: "4rem 0" }}>
            <div style={{
              width: 36, height: 36, border: "2px solid rgba(232,255,71,0.1)", borderTop: "2px solid #E8FF47",
              borderRadius: "50%", animation: "spin 1s linear infinite", margin: "0 auto 1rem"
            }} />
        ...
        {!loading && (<>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{
                color: "rgba(255,255,255,0.45)", fontSize: "0.65rem", fontFamily: "'DM Mono',monospace",
          ...
          <Tilt style={{ marginBottom: "1.1rem", animation: "fadeUp .45s ease both" }}>
            <div style={{
              background: "#0c0c0c", border: "1px solid rgba(255,255,255,0.065)",
              ...
              <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", gap: "0.875rem" }}>
                  ...
                  {editInc ? (
                    <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
                      ...
                      <input type="number" value={income || ""} autoFocus
                        ...
                        onFocus={e => { if (income === 0) setIncome(""); }}
                        onBlur={() => { setEditInc(false); saveIncome(parseFloat(income) || 0); }}
                        onKeyDown={e => { if (e.key === "Enter") { setEditInc(false); saveIncome(parseFloat(income) || 0); } }}
                        style={{
                          background: "transparent", border: "none", borderBottom: "1.5px solid #E8FF47",
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "0.3rem" }}>
                    ...
                    {editPartnerName ? (
                      <input autoFocus value={partnerName}
                        ...
                        style={{
                          background: "transparent", border: "none", borderBottom: "1px solid rgba(255,105,180,0.6)",
                      ...
                      <span onClick={() => partnerEnabled && setEditPartnerName(true)}
                        style={{
                          color: "rgba(255,105,180,0.7)", fontSize: "0.6rem", letterSpacing: "0.15em",
                    ...
                    editPartner ? (
                      <div style={{ display: "flex", alignItems: "center", gap: 3 }}>
                        ...
                        <input
                          ...
                          onFocus={e => { if (partnerIncome === 0) setPartnerIncome(""); }}
                          onBlur={() => {
                            setEditPartner(false);
                            savePartner(partnerName, parseFloat(partnerIncome) || 0, partnerEnabled);
                          }}
                          onKeyDown={e =>
                            e.key === "Enter" &&
                            (setEditPartner(false),
                ...
                <div style={{ display: "flex", gap: "0.625rem", flexWrap: "wrap" }}>
                  {[
                    ...
                    <div key={s.l} style={{
                      background: "#111", border: "1px solid rgba(255,255,255,0.055)",
              ...
              <div style={{ marginTop: "1rem" }}>
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "0.28rem" }}>
                  ...
                  <span style={{
                    color: pct > 80 ? "#FF4757" : pct > 60 ? "#FFA502" : "#E8FF47",
          ...
          <div style={{
            display: "flex", gap: 3, marginBottom: "0.75rem",
            background: "#0c0c0c", border: "1px solid rgba(255,255,255,0.055)",
          ...
          {topTab === "mine" && (
            <div style={{
              display: "flex", gap: 3, marginBottom: "1.1rem",
              background: "#0c0c0c", border: "1px solid rgba(255,255,255,0.055)",
              borderRadius: "10px", padding: 3
            }}>
              {TABS.map(t => (
          ...
          {tab === "subs" && (
            <div style={{ animation: "fadeUp .32s ease both" }}>
                ...
                {subs.map((sub, i) => (
                  <Tilt key={sub.id} style={{ animation: `fadeUp .32s ease ${i * .055}s both` }}>
                    <div style={{
                      ...
                      <div style={{
                        position: "absolute", left: 0, top: "15%", bottom: "15%", width: 2.5,
                        borderRadius: "0 2px 2px 0", background: ACCENTS[sub.ci]
                      }} />
                      <div style={{
                        width: 42, height: 42, borderRadius: "9px", flexShrink: 0, overflow: "hidden",
              ...
              {subs.length === 0 && (
                <div style={{
                  textAlign: "center", padding: "3rem 0", color: "rgba(255,255,255,.12)",
                ...
                {expenses.map((exp, i) => (
                  <Tilt key={exp.id} style={{ animation: `fadeUp .32s ease ${i * .055}s both` }}>
                    <div style={{
                      ...
                      <div style={{
                        width: 38, height: 38, borderRadius: "8px", background: "rgba(255,71,87,.06)",
                        border: "1px solid rgba(255,71,87,.12)", display: "flex", alignItems: "center",
                        justifyContent: "center", fontSize: "1rem", flexShrink: 0, color: "#FF4757"
                      }}>\u25c8</div>
                      <div style={{ flex: 1 }}>
                ...
                {[
                  ...
                  <div key={item.l} style={{ marginBottom: "0.875rem" }}>
                    ...
                    <div style={{ height: 4, background: "rgba(255,255,255,.04)", borderRadius: 2, overflow: "hidden" }}>
                      <div style={{
                        height: "100%", borderRadius: 2, background: item.c,
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.1rem" }}>
              ...
              <button onClick={() => { setShowAdd(false); setSubPayDate(null); }} style={{
                background: "none", border: "none",
                color: "rgba(255,255,255,0.28)", cursor: "pointer", fontSize: 17, padding: 0
              }}>×</button>
            </div>
            ...
            {newSub.title && (
              <div style={{
                ...
                <img src={getLogoUrl(newSub.title)} style={{
            ...
            <div style={{ display: "flex", gap: "0.45rem" }}>
              ...
              <button onClick={addSub} style={{
                flex: 1, padding: "0.65rem", background: "#E8FF47",
      ...
      {showAddExp && (
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.1rem" }}>
              <span style={{ color: "rgba(255,255,255,0.22)", fontSize: "0.62rem", letterSpacing: "0.18em" }}>NEW EXPENSE</span>
              <button onClick={() => { setShowAddExp(false); setExpPayDate(null); }} style={{
                background: "none", border: "none",
                color: "rgba(255,255,255,0.28)", cursor: "pointer", fontSize: 17, padding: 0
              }}>×</button>
            </div>
      ...
      {histId && histSub && (
        <div style={{
          position: "fixed", inset: 0, background: "rgba(0,0,0,0.9)", zIndex: 600,
          display: "flex", alignItems: "center", justifyContent: "center", backdropFilter: "blur(14px)", padding: "1rem"
        }}>
          <div style={{
            background: "#090909", border: "1px solid rgba(255,255,255,0.09)", borderRadius: "16px",
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.1rem" }}>
              ...
              <button onClick={() => setHistId(null)} style={{
                background: "none", border: "none",
                color: "rgba(255,255,255,0.28)", cursor: "pointer", fontSize: 17, padding: 0
              }}>×</button>
            </div>
            {!histSub.history?.length ? (
              <div style={{
                textAlign: "center", padding: "2rem 0", color: "rgba(255,255,255,.12)",
...
export default function App() {
  ...
  if (authLoading) return (
    <div style={{
      ...
      <div>
        <div style={{
          width: 36, height: 36, border: "2px solid rgba(232,255,71,0.1)",
